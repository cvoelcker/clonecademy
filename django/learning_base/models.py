...
class CourseCategory():
    ...
    """
    name = models.CharField(help_text="Name of the category (e.g. biochemistry)", )
...
class Course():
    ...
    name = models.CharField(help_text="A short concise name for the course", unique=True)
...
class Question():
    ...
    """
    name = models.CharField(help_text="A short concise name for the question")

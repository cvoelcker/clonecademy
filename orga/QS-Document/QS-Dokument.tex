...
Das Ziel des Projektes ist eine voll funktionsfähige Webanwendung für Desktop- und Laptoprechner und die aktuellen Versionen der Browser \emph{Firefox} und \emph{Chrome} bereitzustellen. Eine eventuelle Erweiterung der Plattform, um zum Beispiel auch mobile Endgeräte zu unterstützen, wird durch die Implementierung einer REST-Schnittstelle ermöglicht.
...
Eine User Story wird erst zur Abnahme präsentiert, wenn mindestens für alle durch Funktionen, die im Laufe dieser User Story implementiert oder verändert wurden, Tests vorliegen. Ein Release wird erst freigegeben, wenn eine Code Coverage von mindestens 80\% erreicht ist. Die Überprüfung dieser Regeln erfolgt durch den, für das QS-Ziel zuständien, Entwickler.

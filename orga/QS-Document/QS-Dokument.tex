...
Um zum Schluss ein bedienbares Produkt zu haben, werden die Nutzer*innenstudien in mehreren Iterationen und mit unterschiedlichen Personen durchgeführt. Nach jeder Nutzerstudie wird eine Checkliste erstellt mit den Problemen und Verbesserungsvorschläge der Probanden, welche bis zum nächsten treffen mit dem Auftraggeber umgesetzt werden muss. Dieser kann dann die Designänderungen abnehmen und erst durch die abnehme der Designänderungen ist die Iteration der Nutzerstudie abgeschlossen. Zusätzlich sollen die Benutzer im Fragebogen die Platform bewerten, was uns wiederum zeigt wie bedienbar die Platform aktuell ist.

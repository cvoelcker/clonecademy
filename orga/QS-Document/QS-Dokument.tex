...
\lstinputlisting{appendix/ng_lint/ng_lint_06.txt}
...
\lstinputlisting{appendix/nginx-app.conf}
...
\section*{Externe Dokumentation - GitHub Wiki}


\section*{QS-Prozess durch GitHub Issues}

\section*{Endgültiger Stand des Projektes und Übergabeprotokoll}

\chapter{Code Dokumentation Auszüge}
...
\lstinputlisting[language=Java]{appendix/course.service.ts}

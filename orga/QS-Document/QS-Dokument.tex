...
Nach jeder Userstory muss für die Elemente folgende Checkliste beachtet werden:
\begin{itemize}
	\item Wurden die Standarts des Designs eingehalten?
	\item Sind Schaltflächen optisch abgehoben und im gleichen Format wie andere der selben Art?
	\item Sind Buttons durch ihre Position direkt ersichtlich?
	\item Ist wichtiger Text von Nebeninformationen abgetrennt und markant sichtbar?
	\item Sind die Schaltflächen richtig beschriftet und ist durch die Beschriftung erkennbar, was sie machen?
	\item Sind neue Elemente optisch gut unterscheidbar von vorhandenen Elementen?
	\item Ist alles in der Mindestauflösung erkennbar?
/end{itemize}
